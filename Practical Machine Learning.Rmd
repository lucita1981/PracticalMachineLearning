...
####b. Decision Tree
The accuracy of the model is **52.37%** which is pretty bad! Note that the decision tree never predict a D classe. 
```{r, cache=TRUE}
...
The random forest is well suited to generating accurate predictions for this dataset. While a decision tree wasn't able to accurately predict the response.
